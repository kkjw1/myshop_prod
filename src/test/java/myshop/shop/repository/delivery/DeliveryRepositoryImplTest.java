...
class DeliveryRepositoryImplTest {
    ...
    @Test
    public void getOrderNoSetTest() throws Exception {
        //given
        Set<Long> orderNoSet = deliveryRepository.getOrderNoSet(1L);
        System.out.println("orderNoSet = " + orderNoSet);
    }

    @Test
    public void getOrderDeliveryListTest() throws Exception {
        //given
        Set<Long> orderNoSet = deliveryRepository.getOrderNoSet(1L);
        List<OrderDeliveryDto> orderDeliveryList = deliveryRepository.getOrderDeliveryList(orderNoSet);
        System.out.println("orderDeliveryList = " + orderDeliveryList);
    }
}